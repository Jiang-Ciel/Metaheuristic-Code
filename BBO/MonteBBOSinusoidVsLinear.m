function [MeanMin, MeanMinNorm, BestMin, BestMinNorm] = MonteBBOSinusoidVsLinear
...
for j = 1 : nBench
    ...
    % Sinusoidal migration model with no blending
    for k = 1 : nMonte
        [Cost] = eval(['BBO(@', Bench(j,:), ', false, false, 0);']);
